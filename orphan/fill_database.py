...
# df_subset.to_csv("../data/topics_representations_sample.csv", index=False)
...
insert_files = """INSERT OR IGNORE INTO files (file_name, file_date, file_year, source)
VALUES (?, ?, ?, ?)
;"""
...
# with open("../data/topics_representations_sample.csv", encoding="utf-8") as tr:
    ...
    for row in reader:
        ...
        cur.execute(insert_files, (file_name, file_date, file_year, source))
