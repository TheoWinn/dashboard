...
# wenn mehrere themen in einer rede angesprochen werden, wissen wir nict wie lange über ein thema isoliert geredet wird. Dazu habe ich die stats datei erstellt
# 
#
# Modelfragen: 
#   wie kommt das model auf die themen? bsp. "jetzt", warum checkt es nicht dass das ein stopword ist? 
# 
# 
############
...
So: how to understand it in full context: 
